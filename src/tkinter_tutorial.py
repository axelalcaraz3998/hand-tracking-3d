...
class MyGUI:
  def __init__(self):
    ...
    self.check.pack(pady=24)

    self.button = tk.Button(self.root, text="Show Message", font=("Arial", 18), command=self.show_message)
    self.button.pack()

    self.clear_button = tk.Button(self.root, text="Clear Message", font=("Arial", 18), command=self.clear_message)
    self.clear_button.pack(pady=24)
